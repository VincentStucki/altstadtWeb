...
export interface ApiOrteOrte extends Struct.CollectionTypeSchema {
  collectionName: 'ortes';
  info: {
    description: '';
    displayName: 'Orte';
    pluralName: 'ortes';
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orte.orte'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    ortId: Schema.Attribute.UID;
    publishedAt: Schema.Attribute.DateTime;
    saison: Schema.Attribute.Enumeration<
      ['spring', 'summer', 'winter', 'autumn', 'l']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
